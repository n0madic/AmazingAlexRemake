...
void b2PolygonShape::ComputeMass(b2MassData* massData, float32 density) const
{
	...
	// AMAZING ALEX LOCAL CHANGE: this is the 2.1.2 / trunk algorithm (triangles fanned from the local
	// origin, integrals with the explicit reference-point terms) as found in the shipped game; the
	// 2.2.1 version fans from the vertex average and differs at rounding level.
